...
pip install torch==1.13.0+cu116 torchaudio==0.13.0+cu116 -i https://pypi.tuna.tsinghua.edu.cn/simple --extra-index-url https://download.pytorch.org/whl/cu116
...
pip install peft==0.12.0 -i https://pypi.tuna.tsinghua.edu.cn/simple
